...
function WhatIsPigeonDAO() {
  return (
    <div className="relative w-full bg-primaryDarker py-20 px-16">
...
function NewToPigeonDAO() {
  return (
    <div className="relative w-full bg-primaryDarker py-28 px-16 text-center">
